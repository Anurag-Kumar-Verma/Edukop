...
export class PayService {
    ...
    // createOrder(params: any): Observable<interfaces.IResponseGet<interfaces.IRazorpay>> {
    //     return this.http.post<interfaces.IResponseGet<interfaces.IRazorpay>>(environment.Api + '/api/razor/order', params, {
    //         headers: this.authService.headers,
    //     });
    // }

    // capturePayment(params: any): Observable<any> {
